...
def get_logger():
    ...
    rf_handler = logging.handlers.TimedRotatingFileHandler(os.path.join(LOG_DIR, 'all.log'), when='midnight', interval=1, backupCount=10, atTime=datetime.time(0, 0, 0, 0))
